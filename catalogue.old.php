...
?>
		...
		<div class="p2">
			<div class="p2b">
			<div class="man">
				<h2 id="man">Montures Hommes</h2>
				<div class="gal">
					<div class="cat">
						<img id="myImg" src="imgs/cat/l1.jpg" alt="Notre coup de coeur du moment">
						<p>Notre coup de coeur du moment</p>
					</div>
					<div class="cat">
						<img id="myImg2" src="imgs/cat/l2.jpg" alt='Notre coup de coeur "technique"'>
