	...
	<div class="p3">
		<div class="p3b">
			...
			<div class="p3d">
				...
				<p>Par l’approche paramédicale: nous avons à transcrire une prescription médicale en une paire de lunettes qui prend en compte vos besoins visuels en s’inscrivant dans votre quotidien avec le respect de votre façon de vivre, votre personnalité et de votre budget.</p>
